...
class Locators:
    ...
    LINK_CONSTRUCT = (By.XPATH, "//p[text()='Конструктор']/parent::a[1]") # ссылка "Конструктор" идентична для всех страниц
    ...
    NAME = (By.XPATH, "//label[text()='Имя']/following-sibling::input[1]") # поле ввода "Имя"
    ...
    BREAD = (By.XPATH, "//h2[text()='Булки']/following-sibling::ul[1]") # список булок
    SAUCES = (By.XPATH, "//h2[text()='Соусы']/following-sibling::ul[1]") # список соусов
    TOPPINGS = (By.XPATH, "//h2[text()='Начинки']/following-sibling::ul[1]") # список начинок
